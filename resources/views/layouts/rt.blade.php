...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'WargaDigi 21 — Dashboard Admin RT')">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>@yield('title', 'Dashboard') — Admin RT WargaDigi</title>
...
<body class="admin-body">
        ...
        <nav class="sidebar-nav">
            <ul class="sidebar-menu">
                <li class="sidebar-item">
                    <a href="{{ route('rt.dashboard') }}" class="sidebar-link @if(request()->routeIs('rt.dashboard') || request()->is('rt')) active @endif">
                        <i class="bi bi-grid-1x2-fill"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('rt.persetujuan-dokumen') }}" class="sidebar-link @if(request()->routeIs('rt.persetujuan-dokumen')) active @endif">
                        <i class="bi bi-file-earmark-text-fill"></i>
                        <span>Persetujuan Dokumen</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link @if(request()->is('rt/keuangan*')) active @endif">
                        <i class="bi bi-cash-stack"></i>
                        <span>Persetujuan Keuangan</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link @if(request()->is('rt/kas*')) active @endif">
                        <i class="bi bi-wallet2"></i>
                        <span>Keuangan Kas RT</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link @if(request()->is('rt/keluarga*')) active @endif">
            ...
            <ul class="sidebar-menu sidebar-menu-bottom">
                ...
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link text-danger" id="rtLogout">
            ...
            <div class="topbar-right">
                ...
                <div class="topbar-avatar" id="avatarDropdown">
                    <div class="avatar-circle">
                        <span>{{ substr(Auth::user()->name ?? 'RT', 0, 1) }}</span>
                    </div>
                </div>
                <span class="fw-bold text-dark small ms-1">{{ Auth::user()->name ?? 'Admin RT' }}</span>
            </div>
        </header>
    ...
    <div class="admin-notif-panel" id="notifPanel">
        <div class="notif-panel-header">
            <h6><i class="bi bi-bell-fill"></i> Notifikasi RT</h6>
        ...
        <div class="notif-panel-body">
            <div class="notif-item unread">
                ...
                <div class="notif-content">
                    <p class="notif-text">24 dokumen menunggu persetujuan RT</p>
            ...
            <div class="notif-item unread">
                ...
                <div class="notif-content">
                    <p class="notif-text">Laporan iuran bulanan telah diterima</p>
