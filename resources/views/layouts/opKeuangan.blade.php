...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'WargaDigi 21 — Dashboard Operator Keuangan')">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>@yield('title', 'Dashboard') — Operator Keuangan WargaDigi</title>
...
<body class="admin-body">
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <ul class="sidebar-menu sidebar-menu-bottom">
                ...
                <li class="sidebar-item">
                    <form action="{{ route('logout') }}" method="POST" id="logout-form-keuangan" class="w-100">
                        @csrf
                        <a href="#" class="sidebar-link text-danger" onclick="event.preventDefault(); document.getElementById('logout-form-keuangan').submit();">
    ...
    <div class="admin-notif-panel" id="notifPanel">
        <div class="notif-panel-header">
            <h6><i class="bi bi-bell-fill"></i> Notifikasi Operator Keuangan</h6>
        ...
        <div class="notif-panel-body">
            <div class="notif-item unread">
                ...
                <div class="notif-content">
                    <p class="notif-text">Laporan keuangan pending verifikasi RT</p>
            ...
            <div class="notif-item unread">
                ...
                <div class="notif-content">
                    <p class="notif-text">Pemasukan iuran warga telah dicatat</p>
                    <span class="notif-time">4 jam yang lalu</span>
                </div>
            </div>
        </div>
    </div>
