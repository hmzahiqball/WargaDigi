...
<div class="container-fluid px-0">
    ...
    @include('rw.umkm.components.bannerUsahaReadOnly', ['usaha' => $usaha])

    @include('rw.umkm.components.cardStatSummary', [
        ...
        @if(isset($produk) && count($produk) > 0)
            @foreach($produk as $item)
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    @include('rw.umkm.components.cardProdukReadOnly', ['item' => $item, 'usaha' => $usaha])
                </div>
            @endforeach
        @else
            <div class="col-12">
