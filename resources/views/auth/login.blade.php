                    ...
                    <form id="loginForm">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="loginUsername" class="form-control border-start-0" placeholder="Masukkan username" style="border-radius: 0 0.5rem 0.5rem 0;" required autocomplete="username">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" id="loginPassword" class="form-control border-start-0 border-end-0" placeholder="Masukkan password" required autocomplete="current-password">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="rememberMe" style="border-color: #2E7D32;">
